...
import humanizeDuration from "humanize-duration";
 ...
 export const AppContextProvider=(props)=>{
    ...
    const value={
        currency,allCourses,navigate, calculateRating,isEducator,calculateChapterTime,calculateNoOfLectures,calculateCourseDuration,enrolledCourses,fetchUserEnrolledCourses
