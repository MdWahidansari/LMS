...
//   //this navigation for when i click top upper logo it wil open the home page of navbar page
...
//     {
//       user ? <UserButton/>:
//       <button onClick={()=>openSignIn()} className='bg-gray-600 text-white px-5 py-2 rounded-full'>
      ...
      {showPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <h2 className="text-lg font-bold mb-4">You can publish a course now!</h2>
            <button
