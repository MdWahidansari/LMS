...
const Footer = () => {
  return (
    <footer className='bg-[#35334a] ... md:px-36 text-left w-full mt-10'>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
            ...
            <div className='hidden md:flex flex-col items-start w-full'>
              ...
              <div className='flex items-center gap-2 pt-4'>
                <input type="email" placeholder='Enter Your Email' name="" id="" className='border border-gray-500/30 bg-gray-800 text-gray-500 placeholder-gray-500 w-64 h-9 outline-none rounded px-2 text-sm' />
