...
//             <label htmlFor="thumbnailTime" className="flex items-center gap-3">
//               <img
...
//                   <button
//                     type="button"
//                     className="inline-flex bg-gray-700 text-white p-2 rounded cursor-pointer mt-2"
...
//           ))}
//           <div
//             className="flex justify-center items-center bg-blue-100 p-2 mt-4 rounded-lg cursor-pointer"
...
//                 <button
//                   type="button"
//                   className="w-full bg-blue-400 text-white px-4 py-4 rounded"
//                 >
//                   Add
//                 </button>
...
//               : 1,
//           lectureId: uniqid(), // required for Mongoose validation
//         };
...
const addLectureAndSubmit = () => {
  ...
  setChapters(updatedChapters); // Update state

  // Submit course using updatedChapters, not chapters
  submitCourse({
    ...courseDetails,
  ...
  //     console.log("Chapters before submitting:", chapters);
  //   try {
  //     e.preventDefault();
  //     if(!image){
  ...
  try {
    ...
    // Prepare chapters and lectures with required fields
    const preparedChapters = chapters.map((chapter, chapterIndex) => ({
      ...chapter,
    ...
    const courseData = {
      ...
      coursePrice: Number(coursePrice),
      discount: Number(discount),
      courseContent: preparedChapters, // send prepared chapters
    };
        ...
        {showChapterPopup && (
          <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
            <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
              ...
              <button
                type="button"
                className="w-full bg-blue-400 text-white px-4 py-2 rounded mb-2"
                onClick={() => {
