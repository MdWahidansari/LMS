...
const CourseDetails = () => {
  ...
  const [isAllreadyInrolled, setIsAllReadyInrolled] = useState(false);
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        <div className="absolute top-0 left-0 w-full h-section-hight -z-1 bg-gradient-to-b from-cyan-100/70"></div>
                          ...
                          <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                            ...
                            <div className="flex gap-2">
                              {lecture.isPreviewFree && (
                                <p
                                  // clik on previe icon and see the video
                                  onClick={() =>
                                    setPlayerData({
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
              {/* for video of right side ............................................... */}

              <img
                className="w-3.5"
                src={assets.time_left_clock_icon}
                alt="time-left-clck-icon"
              />
            ...
            {/* total number of lecture and total duration section  */}
            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-2 text-gray-500">
              ...
              {/* <div className='flex items-center gap-1'>
                <img src={assets.time_clock_icon} alt="star_icon" />
